...
const { agencyName, agencyCode, source, createdBy } = schema.tree
 ...
 */
router.post('/', body({ agencyName, agencyCode, source, createdBy }), create)
 ...
 * @apiError 404 Projects not found.
 */
router.put('/:id', body({ agencyName, agencyCode, source, createdBy }), update)
