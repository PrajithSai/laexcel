...
const { sourceName, sourceCode, createdBy } = schema.tree
 ...
 */
router.post('/', body({ sourceName, sourceCode, createdBy }), create)
 ...
 * @apiError 404 Projects not found.
 */
router.put('/:id', body({ sourceName, sourceCode, createdBy }), update)
