...
export AcademicYear, { schema } from './model'

const router = new Router()
const { academicYear, createdBy } = schema.tree
 ...
 */
router.post('/', body({ academicYear, createdBy }), create)
 ...
 * @apiError 404 Projects not found.
 */
router.put('/:id', body({ academicYear, createdBy }), update)
